...
> 本文中，我通过bwrap命令对运行Tim的wine程序屏蔽了simsun字体以获得了一个更为舒适的字体渲染效果。我所使用的Tim为`deepin-wine-tim`，至于QQ以及spark商店的Tim可以参考借鉴这里的思路达到同样的效果，而使用其他方法安装simsun字体的网友们注意灵活变通，不要照抄我给出的字体路径。
